...
export default function Header() {
  ...
  return (
    <div>
      <div className='bg-gradient-to-r from-blue-300  via-blue-50 to-blue-500 mb-0'>
        <h1 className='mb-3'>Programmor</h1>
        <p className='py-3'>Car il n'y a que les devs, pour comprendre les devs</p>
      </div>
