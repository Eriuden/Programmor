...
export const InscriptionModal = () => {
  ...
  const handleRegister = async(e:any)=> {
    ...
    const languageError = document.querySelector(".language.error") as HTMLInputElement
    ...
    if(password !== passwordConfError.value || password.length < 8 || !terms.checked) {
      ...
      .then((res:any)=> {
        if (res.data.errors){
          ...
          languageError.innerHTML = res.data.errors.language
        ...
        {formSubmit ? (
          ...
          <form action='' onSubmit={handleRegister} className="bg-slate-100 flex
           ...
           my-4 md:mx-[20%] lg:mx-[20%]">
              ...
              <label htmlFor='language' className='my-2'>Vous codez en quoi ?</label>
